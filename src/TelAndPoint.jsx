...
function TelAndPoint() {
    ...
    return (
        <div className="TelAndPoint">
            ...
            <img data-layer="ดาวน์โหลด 1" className="1" style={{ position: 'absolute', left: 0, top: 240, width: 383, height: 99 }} src="https://t3.ftcdn.net/jpg/05/79/34/92/360_F_579349293_XUTidUs5U3tZShFUNz5W5w7CKInHIJtg.jpg" />
